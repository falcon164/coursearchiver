# Course Archiver
This tool is a fork of Moodle's Course Archiver plugin which is used to search for courses, notify the course owners, and mass hide or archive (backup and remove) courses. This fork has two new features i.e. search by term (course custom attribute) and sync the course backup files to AWS S3 storage.  
