...
$string['cli_question_deleteemail'] = 'Send these {$a} users a "Course to be deleted" email?';
...
$string['confirmmessagedeleteemail'] = 'send an email notification of pending course deletion to these {$a} course owners?';
$string['confirmmessagehide'] = 'hide these {$a} courses?';
$string['confirmmessagehideemail'] = 'send an email notification of pending courses to be hidden to these {$a} course owners?';
...
$string['coursearchiver:views3synclog'] = 'View S3 Sync Log';
...
//APU Fork starts here - To add Term filter
$string['term'] = 'Term';
$string['searchbyterm'] = 'Term (course custom field shortname: term)';
$string['filter_term_help'] = 'Filter courses whose custom field "term" matches one or more values (comma-separated), e.g. 2025-Fall,2025-Spring.';
//APU Fork ends here
...
$string['deleteemail'] = 'Send "Course to be Deleted" Emails';
$string['deletewarningemailsetting'] = 'Default Email Warning for Course Deletion';
$string['deletewarningemailsetting_help'] = 'This is the contents of an email that will be sent to all owners of a course that is selected to be deleted.';
$string['deletewarningemailsettingdefault'] = '%to

We would like to inform you that the following Moodle course(s) that you have taught are soon to be deleted.
This means that the course will be removed from Moodle.  If you would like to opt out of this process for one of the following courses, please click the link beside the course.
...
$string['optoutdelete'] = 'Do not delete this course';
...
$string['results_deleteemail'] = 'Course deletion warning emails sent: {$a}';
...
$string['archivelocation_term_based'] =
    'Archive folders are created per course using the Term custom field.';


$string['sync'] = 'Sync to S3';
$string['term'] = 'Academic Term';
$string['notermsfound'] = 'No archive terms found';
$string['syncarchivestos3'] = 'Sync Archives to S3';


// Language strings for tool_coursearchiver

$string['s3sync'] = 'Sync Archives to S3';
$string['s3syncheading'] = 'Sync Course Archives to Amazon S3';
$string['s3syncdescription'] = 'Select an academic term and sync archived course backups to Amazon S3.';
$string['s3syncterm'] = 'Select term';
$string['s3syncbutton'] = 'Sync to S3';
$string['s3syncqueued'] = 'S3 sync has been queued successfully.';
$string['s3synclog'] = 'S3 Sync Logs';
