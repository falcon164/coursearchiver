...
require_login();
admin_externalpage_setup('toolcoursearchiver_main');

global $SESSION, $OUTPUT;

$context = context_system::instance();
$PAGE->set_url(new \moodle_url('/admin/tool/coursearchiver/savestatelist.php'));
$PAGE->navbar->add(get_string('savestatelist', 'tool_coursearchiver'));
...
$list = tool_coursearchiver_processor::get_savestatelist();
